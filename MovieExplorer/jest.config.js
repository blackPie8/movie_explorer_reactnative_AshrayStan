module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!(react-native|@react-native|@react-navigation|react-native-linear-gradient|react-native-button|react-native-element-dropdown|react-native-gesture-handler|react-native-reanimated|react-native-reanimated-carousel|toastify-react-native|another-library-to-transform|@react-native-async-storage/async-storage|@react-native-firebase/messaging))',
